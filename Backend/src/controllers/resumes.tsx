...
export const resumeController = {
  uploadResume: async (req: Request, res: Response) => {
    try {
      ...
      res
        .status(201)
        .json({ message: "Resume uploaded successfully", resumeId: resume.id });
    } catch (error) {
      ...
      res
        .status(500)
        .json({ error: "An error occurred while uploading the resume" });
    }
  },
  ...
  downloadResume: async (req: Request, res: Response) => {
    try {
      ...
      res
        .status(500)
        .json({ error: "An error occurred while downloading the resume" });
    }
  },
  ...
  getUserResumes: async (req: Request, res: Response) => {
    try {
      ...
      res
        .status(500)
        .json({ error: "An error occurred while fetching user resumes" });
    }
  },
  ...
  generateResumeResume: async (req: Request, res: Response) => {
    try {
      ...
      res
        .status(500)
        .json({ error: "An error occurred while generating the resume" });
    }
  },
};
