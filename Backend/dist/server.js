...
app.post('/register', upload.single('profilePicture'), users_1.userController.register);
...
app.put('/users/:id', authenticateToken, upload.single('profilePicture'), users_1.userController.updateUser);
...
app.get('/resumes/:id', authenticateToken, resumes_1.resumeController.downloadResume);
